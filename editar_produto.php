...
<body>
  ...
  <?php 
    while ($use_data = mysqli_fetch_assoc($result)){
        ...
        echo "<td> <a href='edit_produto.php?id=$use_data[id]' class='btn btn-primary btn-sm'>Editar</a> </td>";
        echo "<td> <a href='delete_produto.php?id=$use_data[id]'class='btn btn-primary btn-sm'>Excluir</a> </td>";
